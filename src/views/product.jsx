...
const Product = () => {
  ...
  <div className="container-fluid py-5">
    <div className="row px-xl-5">
        ...
        <div id="product-carousel" className="carousel slide" data-ride="carousel">
          ...
          {data.galleries?.map((gal)=>{
                            return <div className="carousel-item active">
                              <img className="w-100 h-100" src={"http://localhost:3000/file/products/"+gal} alt="Image" />
                            </div>
                          })}
          </div>
      ...
      <div className="col-lg-7 pb-5">
        <h3 className="font-weight-semi-bold">{data.description}</h3>
        <div className="d-flex mb-3">
          ...
          <small className="pt-1">({data.qte} Availables)</small>
        </div>
  ...
  <div className="container-fluid py-5">
    ...
    <div className="row px-xl-5">
      <div className="col">
        <div className="owl-carousel related-carousel" style={{display:"flex"}}>
        {products.slice(products.length-4, products.length+1).reverse().map((item) => {
                    return (
          <div className="card product-item border-0">
            <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
            {item.galleries?.map((gal)=>{
                            return <img className="img-fluid w-100" src={"http://localhost:3000/file/products/"+gal} alt />
                          })}
            </div>
            <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
              <h6 className="text-truncate mb-3">{item.description}</h6>
            ...
            <div className="card-footer d-flex justify-content-between bg-light border">
              ...
              <Link to={`/product/${item._id}`}><a href className="btn btn-sm text-dark p-0"><i className="fas fa-eye text-primary mr-1" />View Detail</a></Link>
