...
const Layout = () => {
    ...
    {categories.map((item) => {
                    return (
                      ...
                      <div className="cat-item d-flex flex-column border mb-4" style={{padding: 30}}>
                        <p className="text-right">{item.subcategories.length} subcategories</p>
                        <a href className="cat-img position-relative overflow-hidden mb-3">
                            <img className="img-fluid" src={"http://localhost:3000/file/categories/"+item.file} alt />
                        </a>
    ...
    {products.map((item) => {
                    return (
                        ...
                        <div className="card product-item border-0 mb-4">
                          ...
                          <img className="img-fluid w-100" src={"http://localhost:3000/file/products/"+item.galleries[0]} alt />
                          </div>
  ...
  <div className="container-fluid pt-5">
    ...
    <div className="row px-xl-5 pb-3">
    {products.slice(products.length-8, products.length+1).reverse().map((item) => {
                    return (
                        <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                        <div className="card product-item border-0 mb-4">
                          <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
